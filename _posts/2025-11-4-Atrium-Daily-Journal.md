...
![IMG_2389](https://github.com/carolineuys/Caroline-Uys-Portfolio/blob/master/assets/images/IMG_2389.jpg)
![IMG_2388](https://github.com/carolineuys/Caroline-Uys-Portfolio/blob/master/assets/images/IMG_2388.jpg)
![IMG_2387](https://github.com/carolineuys/Caroline-Uys-Portfolio/blob/master/assets/images/IMG_2387.jpg)
![IMG_2385](https://github.com/carolineuys/Caroline-Uys-Portfolio/blob/master/assets/images/IMG_2385.jpg)
...
![IMG_2390](https://github.com/carolineuys/Caroline-Uys-Portfolio/blob/master/assets/images/IMG_2390.jpg)
...
![clamppic](https://github.com/carolineuys/Caroline-Uys-Portfolio/blob/master/assets/images/clamppic)
![clamppic2](https://github.com/carolineuys/Caroline-Uys-Portfolio/blob/master/assets/images/clamppic2)
...
---
# Summer Update
As of right now, I have finished designing all parts of the clamp and I am now focusing on finding the smaller parts in bulk, like screws, springs, rubber, and heat-set inserts. From my research on springs, I have found that the type I need are 3 loop, 180º, torsion springs that have a large enough diameter to fit around the pegs, but I have not been able to find that anywhere online. There was one place that I could design a custom spring, but that was far too expensive for a project where one of the main goals is to significantly reduce costs. Some websites I have looked at are McMaster-Carr, Lee Spring, and Misumi, but I have so far been unsuccessful in finding an affordable option for the springs in bulk. As for the screw parts, those can be found on McMaster-Carr and then melted into handles designed on Fusion using the same technique as the heat-set inserts. All of the correct heat-set inserts have been found and the design has been adjusted to fit the inserts as well. 
